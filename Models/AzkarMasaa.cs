...
namespace AzkaryApp.Models
{
    ...
    public class AzkarMasaaData
    {
        private List<AzkarMasaa> azkarMasaas = new List<AzkarMasaa>()
       {
           new AzkarMasaa()
           {
               ZekrId = 1,
                 ...
                 new AzkarMasaa()
           {
               ZekrId = 5,
               ZekrCount= 1,
               ZekrName="أمسينا وأمسى الملك لله، وَالْحَمْدُ لِلَّهِ، لاَ إِلَهَ إلاَّ اللَّهُ وَحْدَهُ " +
"لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، رَبِّ "+
"ربِّ أسألك خير ما في هذه الليلة وخير ما بعدها وأعوذ بك من شر ما في هذه الليلة وشر ما بعدها ، " +
" رَبِّ أَعُوذُ بِكَ مِنَ الْكَسَلِ وَسُوءِ الْكِبَرِ، رَبِّ أَعُوذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ"
                   ...
                   new AzkarMasaa()
           {
               ZekrId = 6,
               ZekrCount= 1,
               ZekrName="اللهم بك أمسينا وبك أصبحنا وبك نحيا وبك نموت وإليك المصير"
           },
                     new AzkarMasaa()
           {
               ZekrId = 7,
                       ...
                       new AzkarMasaa()
           {
               ZekrId = 8,
               ZekrCount= 4,
               ZekrName="اللَّهُمَّ إِنِّي أمسيت أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلاَئِكَتِكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللَّهُ لَا إِلَهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسُولُكَ"
           },
                         new AzkarMasaa()
           {
               ZekrId = 9,
...
" الْعَظِيمِ "
                   ...
                   new AzkarMasaa()
           {
               ZekrId = 17,
               ZekrCount= 1,
               ZekrName="أمسينا وَأمسى الْمُلْكُ لِلَّهِ رَبِّ الْعَالَمِينَ، اللَّهُـمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَه الليلة:فَتْحَهُا، وَنَصْرَهُا، وَنورَهُا، وَبَرَكَتَهُا، وَهُدَاهُا، "+
                       "وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِيهِا وَشَرِّ مَا بَعْدَهُا"
           },
                  new AzkarMasaa()
           {
               ZekrId = 18,
               ZekrCount= 1,
               ZekrName="أمسينا عَلَى فِطْرَةِ الْإِسْلاَمِ، وَعَلَى كَلِمَةِ الْإِخْلاَصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ - صلى الله عليه وسلم -، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ، حَنِيفاً مُسْلِماً وَمَا كَانَ مِنَ الْمُشرِكِينَ"
           },
               new AzkarMasaa()
           {
               ZekrId = 19,
        ...
        public List<AzkarMasaa> AzkarMasaas { get => azkarMasaas; set => azkarMasaas = value; }
    }
}