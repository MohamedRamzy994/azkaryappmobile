...
namespace AzkaryApp.Models
{
    ...
    public class AzkarEsteqazData
    {
        private List<AzkarEsteqaz> azkarEsteqazs = new List<AzkarEsteqaz>()
       {
           new AzkarEsteqaz()
           {
               ZekrId = 1,
               ZekrCount= 1,
               ZekrName=" الْحَمْدُ للَّهِ الَّذِي أَحْيَانَا بَعْدَ مَا أَمَاتَنَا، وَإِلَيْهِ النُّشُورُ"
           },
        ...
        public List<AzkarEsteqaz> AzkarEsteqazs { get => azkarEsteqazs; set => azkarEsteqazs = value; }
    }
}